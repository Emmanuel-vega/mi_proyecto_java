package com.carlos.infrastructure.config;

import com.carlos.domain.port.input.LoginPort;
import com.carlos.domain.port.output.JwtGeneratorPort;
import com.carlos.domain.port.output.PasswordCheckerPort;
import com.carlos.domain.port.output.UserRepositoryPort;
...
public class BeanConfig {
     ...
     */
    private final PasswordCheckerPort passwordCheckerPort;
